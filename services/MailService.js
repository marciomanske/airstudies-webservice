...
var MailService = function () {
    ...
    var getContent = function (fullName, link, fileName, cb) {
        var template = __dirname + "/../html/" + fileName;
    ...
    return {
        ...
        getEmailRecoveryContent: function (fullName, link, cb) {
            getContent(fullName, link, "lostpasswordemailtemplate.html", cb);
        },
        getEmailCreatePasswordContent: function (fullName, link, cb) {
            getContent(fullName, link, "createpasswordemailtemplate.html", cb);
        }
